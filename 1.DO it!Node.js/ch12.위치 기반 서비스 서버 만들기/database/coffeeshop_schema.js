...
Schema.createSchema = function (mongoose) {
  ...
  //가장 가까운 커피숍 조회
  CoffeeShopSchema.static("findNear", function (
    logitude,
    latitude,
    maxDistance,
    callback
  ...
  //일정 범위 안의 커피숍 조회
  CoffeeShopSchema.static("findWithin", function (
    topleft_longitude,
    topleft_latitude,
    bottomrignt_longitude,
    bottomrignt_latitude,
    callback
  ) {
    ...
    this.find()
      ...
      .within({
        box: [
          ...
          [parseFloat(bottomrignt_longitude), parseFloat(bottomrignt_latitude)],
        ],
      })
      .exec(callback);
  });
  ...
  //일정 반경 안의 커피숍 조회
  CoffeeShopSchema.static("findCircle", function (
    center_longitude,
    center_latitude,
    radius,
    callback
